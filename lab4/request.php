...
{
    $data = getPosts();
    $insert_Query = "INSERT INTO `request` (`RName`, `CName`, `Terms`, `Amount`) VALUES ('$data[1]','$data[2]', '$data[3]', '$data[4]')";
    try{
...
<html>
    ...
    <body>
        ...
        <div class="form-inner">
            ...
            <input type="text" name="Amount" placeholder="Amount" value="<?php echo $Amount;?>"><br><br>
